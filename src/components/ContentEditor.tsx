...
function DraggableFile({
	...
	return (
		<div key={node.path} className="select-none">
			<div
				ref={ref}
				className={`flex items-center group px-2 py-1.5 rounded-lg text-sm transition-colors cursor-pointer relative ${isSelected
				...
				<div className="flex items-center justify-between px-3 sm:px-6 py-3 sm:py-4 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50">
					...
					<div className="flex items-center gap-1 sm:gap-2">
						...
						<button
							...
							className={`flex items-center gap-1.5 px-3 sm:px-4 py-2 rounded-lg font-medium transition-colors shadow-sm text-sm ${isDirty ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-gray-100 dark:bg-gray-800 text-gray-500'
								}`}
						>
