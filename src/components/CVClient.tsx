...
export default function CVClient() {
	...
	return (
		<div className={`${cmunrm.className} max-w-[210mm] mx-auto py-8 shadow-lg dark:shadow-2xs m-8 p-4 bg-bg-light dark:bg-bg-dark text-fg-light dark:text-fg-dark`}>
			{<style dangerouslySetInnerHTML={{
				__html: `
	                ...
	                `}} />}
			<div id="pdf" className="print:absolute print:left-0 print:top-0 print:w-[210mm]">
					...
					<div className="flex items-center mt-2">
						...
						<div className="w-2/3 text-left pl-3">
							<h3 className="font-normal m-1 text-base">
								...
								<a href="https://valerioiacobucci.com/public/downloads/pdf/tesi_triennale-iacobucci_valerio-0000976541.pdf" className="text-blue-600 dark:text-blue-500 hover:underline">
	...
	return (
		<div className="flex items-center mt-6 mb-2">
			...
			<div className="w-2/3 text-left pl-3 pr-6">
				<hr className="border-t-[0.5px] border-fg-light dark:border-fg-dark w-full" />
			</div>
		</div>
	);
}
