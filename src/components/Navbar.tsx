          ...
          <div className="flex items-center md:hidden">
            <AnimatePresence>
              {!isHome && (
                ...
                >
                  <Link href="/" className="flex items-center gap-1 text-sm font-medium text-gray-500 dark:text-gray-300">
                    <div className="w-12 flex justify-center items-center h-10">
                      <div className="w-10 h-10 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center overflow-hidden hover:scale-105 transition-transform">
            ...
            <div className="hidden md:flex md:space-x-8">
              <Link
                ...
                className={`inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium transition duration-150 ease-in-out ${
                  pathname === '/'
                    ? 'border-gray-700 dark:border-white text-gray-900 dark:text-white'
                ...
                <Link
                  ...
                  className={`block pl-3 pr-4 py-2 border-l-4 text-base font-medium transition duration-150 ease-in-out ${
                    pathname === link.href
                      ...
                      : 'border-transparent text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800 hover:border-gray-300'
                  }`}
                >
                  {link.label}
                </Link>
