		...
		<div className="max-w-7xl mx-auto px-6 sm:px-12">
			<div className="flex flex-col items-center gap-12 w-full md:w-[80%] lg:w-[66%] mx-auto">
				<div className="text-center space-y-4 w-full">
					<div className="h-12 w-64 bg-gray-100 dark:bg-gray-800 rounded-lg animate-pulse mx-auto" />
					<div className="h-6 w-full max-w-2xl bg-gray-100 dark:bg-gray-800 rounded-lg animate-pulse mx-auto" />
				</div>
				<div className="w-full h-[400px] bg-gray-100 dark:bg-gray-800 rounded-3xl animate-pulse" />
			</div>
		</div>
	);
}
